...
#define __PYX_HAVE__cscipy__distance
#define __PYX_HAVE_API__cscipy__distance
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'cscipy.distance' */
...
#define __Pyx_MODULE_NAME "cscipy.distance"
extern int __pyx_module_is_main_cscipy__distance;
int __pyx_module_is_main_cscipy__distance = 0;

/* Implementation of 'cscipy.distance' */
...
static const char __pyx_k_tmpss[] = "tmpss";
...
static const char __pyx_k_cscipy_distance[] = "cscipy.distance";
...
static const char __pyx_k_cscipy_distance_pyx[] = "cscipy/distance.pyx";
...
static PyObject *__pyx_n_s_cscipy_distance;
static PyObject *__pyx_kp_s_cscipy_distance_pyx;
...
static PyObject *__pyx_n_s_tmpss;
...
static PyObject *__pyx_pf_6cscipy_8distance_euclidean(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_A); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6cscipy_8distance_1euclidean(PyObject *__pyx_self, PyObject *__pyx_arg_A); /*proto*/
static PyMethodDef __pyx_mdef_6cscipy_8distance_1euclidean = {"euclidean", (PyCFunction)__pyx_pw_6cscipy_8distance_1euclidean, METH_O, 0};
static PyObject *__pyx_pw_6cscipy_8distance_1euclidean(PyObject *__pyx_self, PyObject *__pyx_arg_A) {
  __Pyx_memviewslice __pyx_v_A = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("euclidean (wrapper)", 0);
  assert(__pyx_arg_A); {
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_arg_A, PyBUF_WRITABLE); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cscipy.distance.euclidean", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6cscipy_8distance_euclidean(__pyx_self, __pyx_v_A);
...
static PyObject *__pyx_pf_6cscipy_8distance_euclidean(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_A) {
 ...
 *         Py_ssize_t ii, jj, kk
 */
  __pyx_v_nrow = (__pyx_v_A.shape[0]);

  /* "cscipy/distance.pyx":22
 *         # Py_ssize_t is just a special platform-specific type for indices
 *         Py_ssize_t nrow = A.shape[0]
 *         Py_ssize_t ncol = A.shape[1]             # <<<<<<<<<<<<<<
 *         Py_ssize_t ii, jj, kk
 * 
 */
  __pyx_v_ncol = (__pyx_v_A.shape[1]);

  /* "cscipy/distance.pyx":27
 ...
 */
  ...
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_nrow); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_nrow); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 27, __pyx_L1_error)
 ...
 */
  __pyx_t_9 = __pyx_v_nrow;
  __pyx_t_10 = __pyx_t_9;
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    __pyx_v_ii = __pyx_t_11;

    /* "cscipy/distance.pyx":34
 *     # exploit the symmetry of D by only looping over its upper triangle
 *     for ii in range(nrow):
 *         for jj in range(ii + 1, nrow):             # <<<<<<<<<<<<<<
 *             # we use tmpss to accumulate the SSD over each pair of rows
 *             tmpss = 0
 */
    __pyx_t_12 = __pyx_v_nrow;
    __pyx_t_13 = __pyx_t_12;
    for (__pyx_t_14 = (__pyx_v_ii + 1); __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      __pyx_v_jj = __pyx_t_14;

      /* "cscipy/distance.pyx":36
 *         for jj in range(ii + 1, nrow):
 *             # we use tmpss to accumulate the SSD over each pair of rows
 *             tmpss = 0             # <<<<<<<<<<<<<<
 ...
 *                 tmpss += diff * diff
 */
      __pyx_t_15 = __pyx_v_ncol;
      __pyx_t_16 = __pyx_t_15;
      for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
        __pyx_v_kk = __pyx_t_17;

        /* "cscipy/distance.pyx":38
 *             tmpss = 0
 *             for kk in range(ncol):
 *                 diff = A[ii, kk] - A[jj, kk]             # <<<<<<<<<<<<<<
 *                 tmpss += diff * diff
 ...
 */
        ...
        __pyx_v_diff = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_18 * __pyx_v_A.strides[0]) ) + __pyx_t_19 * __pyx_v_A.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_20 * __pyx_v_A.strides[0]) ) + __pyx_t_21 * __pyx_v_A.strides[1]) ))));

        /* "cscipy/distance.pyx":39
 *             for kk in range(ncol):
 *                 diff = A[ii, kk] - A[jj, kk]
 *                 tmpss += diff * diff             # <<<<<<<<<<<<<<
 *             tmpss = sqrt(tmpss)
 *             D[ii, jj] = tmpss
 */
        __pyx_v_tmpss = (__pyx_v_tmpss + (__pyx_v_diff * __pyx_v_diff));
      }

      /* "cscipy/distance.pyx":40
 *                 diff = A[ii, kk] - A[jj, kk]
 *                 tmpss += diff * diff
 *             tmpss = sqrt(tmpss)             # <<<<<<<<<<<<<<
 *             D[ii, jj] = tmpss
 ...
 */
      __pyx_v_tmpss = sqrt(__pyx_v_tmpss);

      /* "cscipy/distance.pyx":41
 *                 tmpss += diff * diff
 *             tmpss = sqrt(tmpss)
 *             D[ii, jj] = tmpss             # <<<<<<<<<<<<<<
 *             D[jj, ii] = tmpss  # because D is symmetric
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_D.diminfo[1].strides) = __pyx_v_tmpss;

      /* "cscipy/distance.pyx":42
 *             tmpss = sqrt(tmpss)
 *             D[ii, jj] = tmpss
 *             D[jj, ii] = tmpss  # because D is symmetric             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_25, __pyx_pybuffernd_D.diminfo[1].strides) = __pyx_v_tmpss;
    }
  }

  /* "cscipy/distance.pyx":44
 *             D[jj, ii] = tmpss  # because D is symmetric
 * 
 *     return D             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cscipy.distance.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cscipy.distance._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cscipy_distance, __pyx_k_cscipy_distance, sizeof(__pyx_k_cscipy_distance), 0, 0, 1, 1},
  {&__pyx_kp_s_cscipy_distance_pyx, __pyx_k_cscipy_distance_pyx, sizeof(__pyx_k_cscipy_distance_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_tmpss, __pyx_k_tmpss, sizeof(__pyx_k_tmpss), 0, 0, 1, 1},
 ...
 *     # declare C types for as many of our variables as possible. note that we
 */
  __pyx_tuple__26 = PyTuple_Pack(10, __pyx_n_s_A, __pyx_n_s_A, __pyx_n_s_nrow, __pyx_n_s_ncol, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_kk, __pyx_n_s_D, __pyx_n_s_tmpss, __pyx_n_s_diff); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(1, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cscipy_distance_pyx, __pyx_n_s_euclidean, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 15, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cscipy__distance) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cscipy.distance")) {
      if (unlikely(PyDict_SetItemString(modules, "cscipy.distance", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     # declare C types for as many of our variables as possible. note that we
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6cscipy_8distance_1euclidean, NULL, __pyx_n_s_cscipy_distance); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_euclidean, __pyx_t_1) < 0) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cscipy.distance", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cscipy.distance");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
